Page({
  data: {
    ...
    isAgreed: false,
    loading: false,
    showMobileField: false, // 是否显示手机号字段
  ...
  startCountdown() {
    let timer = setInterval(() => {
      this.setData({
        ...
        captchaBtnText: `${this.data.countdown}s后重新获取`
      });
  ...
  handleRegister(e) {
    ...
    setTimeout(() => {
      ...
      //     username, 
      //     password,
      //     mobile: this.data.showMobileField ? mobile : undefined,
      //     captcha: this.data.showMobileField ? captcha : undefined
      //   },
      //   success: (res) => {
